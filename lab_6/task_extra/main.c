...
extern "C" void dop_func(int* intervals, int n_int, int* units, int n_units, int x_min, int* sum_int);
...
int main() {
	...
	dop_func(intervals, n_int, units, x_max - x_min + 1, x_min, sum_int);
